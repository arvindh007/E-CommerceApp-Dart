...
class violinsProducts extends StatefulWidget {
  const violinsProducts({Key? key}) : super(key: key);

  @override
  _violinsProductsState createState() => _violinsProductsState();
}

class _violinsProductsState extends State<violinsProducts> {
  ...
  void initState() {
    ...
    productsStream = FirebaseFirestore.instance
        .collection('product')
        .where('Catagory', isEqualTo: 'violins'.trim())
